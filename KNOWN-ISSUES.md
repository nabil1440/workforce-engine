...
- Complete the frontend features set and verify all user flows against the API contract, I would first manually write some frontend features, and then let the AI generate the rest of the frontend code based on the patterns established in the manually written features. This would allow me to ensure that the frontend is fully functional and meets the requirements of the API contract.
